...
class AscendMLAImpl(MLAAttentionImpl):
    ...
    def process_weights_after_loading(self, act_dtype: torch.dtype):
        ...
        if get_ascend_config().enable_weight_nz_layout:
            ...
            self.W_UV.data = torch_npu.npu_format_cast(self.W_UV.data, ACL_FORMAT_FRACTAL_NZ)
            self.W_UK_T.data = torch_npu.npu_format_cast(self.W_UK_T.data, ACL_FORMAT_FRACTAL_NZ)
